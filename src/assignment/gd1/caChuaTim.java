...
public class caChuaTim extends Tomatos{
    ...
    public caChuaTim(String khuyenMai, String idTomato, String nameTomato, String colorTomato, String giaTomato) {
        super(idTomato, nameTomato, colorTomato, giaTomato);
        this.khuyenMai = khuyenMai;
    }
